...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('/css/set.css') }}" />

  <!-- formulaire css -->
  <link rel="stylesheet" href="{{ URL::asset('/css/style_formulaire.css') }}" />
  ...
  <link href="{{ URL::asset('/css/set.css') }}" rel="stylesheet" type="text/css">
...
<body>
      ...
      <div class="Menu Menu-default Menu-fixed-top" role="Navigigation" id="top-Navig">
        <div class="container">
          <div class="Menu-header">
            <!-- Logo Starts -->
            <a class="Menu-logo" href="#home"><img src="{{ URL::asset('/image/logo-compressor.png') }}" alt="logo"></a>
            <!-- #Logo Ends -->
  ...
  <div id="home">
    <!-- Acceuil Starts -->
    <div class="Acceuil">
      <img src="{{ URL::asset('/image/colton.jpg') }}" class="superbg"/>
...
en vous inscrivant à notre Home Party (réunion à domicile) Zen@Home</h1>
  ...
  <div id="HomeParty"  class="container spacer HomeParty">
    <div class="row">
      ...
      <div class="tab50-50 wowload fadeInRight">
        <img src="{{ URL::asset('/image/meditation.jpg') }}" class="img-HomeParty wowload img-responsive"></img>
      </div>
    </div>
  </div>
  <!-- HomeParty Ends -->
  ...
  <div id="Articles"  class="clearfix grid">
    <figure class="effect-oscar  wowload fadeinup">
      <img src="{{ URL::asset('/image/meditation.jpg') }}" class="img-responsive"/>
      <figcaption>
        <h6>Méditation</h6>
      ...
      <figure class="effect-oscar  wowload fadeinup">
        <img src="{{ URL::asset('/image/oracle.jpg') }}" class="img-responsive"/>
        <figcaption>
          <h6>Oracle</h6>
          <p>Zen@home et sa multitude de choix bien-être<br>
        ...
        <figure class="effect-oscar  wowload fadeinup">
          ...
          <figure class="effect-oscar  wowload fadeinup">
            <img src="{{ URL::asset('/image/Bien-être.jpg') }}" class="img-responsive"/>
            <figcaption>
              <h6>Thé</h6>
              <p>Zen@home et sa multitude de choix bien-être<br>
            ...
            <figure class="effect-oscar  wowload fadeinup">
              <img src="{{ URL::asset('/image/thé.jpg') }}" class="img-responsive"/>
              <figcaption>
                <h6>lithothérapie</h6>
                <p>Zen@home et sa multitude de choix bien-être<br>
              ...
              <div id="Création"  class="container spacer HomeParty">
                <div class="row">
                  <div class="container wowload fadeInLeft contactform">
                    ...
                    <form id="index" method="post" action="{{ route('sendmail') }}" class="form-inline">
                      <p class="text-form">Contactez-nous pour créer sur mesure votre zen@home party. Ensemble nous définirons une date, les thèmes à aborder, la liste des invités...
                        ...
                        <div class="date">
                          ...
                          @foreach ($datas as $value)
                            <div class="form-group">
                              <label class="container_form">{{ $value->nom_jour." ".$value->nb_jour." ".$value->mois." ".$value->year }}
                ...
                <!-- # Footer Ends -->
                <a id="gottothetop" href="#home" class="gototop"><img src="{{ URL::asset('/image/Arrow_up.png') }}" width="35px" height="35px"></a>
