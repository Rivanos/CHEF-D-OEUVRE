...
<?php echo $__env->make('client/heart', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- début ribbon -->
...
<!-- fin ribbon -->
<!-- fin listing article -->
<?php echo $__env->make('client/mostsells', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
